...
class BookmarksRepository
{
   ...
   */
  // Note to future self: when there's N number of optional query params, build the database query recursively.
  // Else I end up writing every combination of queries manually like I did here.
