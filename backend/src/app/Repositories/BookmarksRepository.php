...
class BookmarksRepository
{
   ...
   */
  //TODO: Current implementation is checking the query params one-by-one to choose the appropriate query.
  // This works when there's only 2 query params but does not scale. Build the query recursively, or use a 3rd party package.
